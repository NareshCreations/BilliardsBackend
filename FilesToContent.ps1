# PowerShell Script to Display All Files with Unique Delimiter
# Save this as: display-src-files-v2.ps1
...
try {
    ...
    Write-Host "Using unique delimiter: <<Naresh><Claud->Script->File>>" -ForegroundColor Cyan
    Write-Host ""
